...
**Project**: identical-layout-creator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build a UI interface that is identical in layout ot this image 
...
```sh
git clone https://github.com/GPT-Engineer-App/identical-layout-creator.git
cd identical-layout-creator
npm i
